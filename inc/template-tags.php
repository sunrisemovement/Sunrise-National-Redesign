...
if ( ! function_exists( 'surnise_national_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function surnise_national_posted_on() {
...
if ( ! function_exists( 'surnise_national_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function surnise_national_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'surnise_national_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function surnise_national_entry_footer() {
...
if ( ! function_exists( 'surnise_national_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function surnise_national_post_thumbnail() {
